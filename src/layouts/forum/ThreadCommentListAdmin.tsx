...
import ThreadRowAdmin from "./ThreadRowAdmin";
import { deleteThreadComment, getListThreadComment } from "../../api/ThreadCommentAPI";
import ThreadCommentRowAdmin from "./ThreadCommentRowAdmin";

function ThreadCommentListAdmin() {
...
export default ThreadCommentListAdmin;