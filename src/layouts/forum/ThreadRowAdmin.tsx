...
import { getThreadCatById, getThreadCatByThreadId } from "../../api/ThreadCatAPI";
...
const ThreadRowAdmin: React.FC<ThreadRowInterface> = (props) => {
