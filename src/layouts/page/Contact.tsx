    ...
    return (
        <section className="py-5">
            <div className="container px-5">
                ...
                <div className="row gx-5 row-cols-2 row-cols-lg-4 py-5 text-start">
                    <div className="col">
                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3 text-center p-2 w-25"><i className="bi bi-chat-dots"></i></div>
                        <div className="h5 mb-2">Chat with us</div>
                        <p className="text-muted mb-0">Chat live with one of our support specialists.</p>
                    </div>
                    <div className="col">
                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3 text-center p-2 w-25"><i className="bi bi-people"></i></div>
                    ...
                    <div className="col">
                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3 text-center p-2 w-25"><i className="bi bi-question-circle"></i></div>
                        <div className="h5">Support center</div>
                        <p className="text-muted mb-0">Browse FAQ's and support articles to find solutions.</p>
                    </div>
                    <div className="col">
                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3 text-center p-2 w-25"><i className="bi bi-telephone"></i></div>
